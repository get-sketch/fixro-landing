...
export default function GDPR() {
  ...
  return (
    <LegalLayout titleRo="Conformitate GDPR" titleEn="GDPR Compliance">
      ...
      <p>{t(
        "Puteți solicita ștergerea datelor. Folosiți pagina noastră de ștergere a datelor sau trimiteți-ne un email. Notă: anumite date trebuie păstrate pentru conformitatea legală (evidențe fiscale - 6 ani).",
        "You can request deletion of your data. Use our Data Deletion Request page or email us. Note: certain data must be retained for legal compliance (tax records for 6 years)."
      )}</p>
      ...
      <ul>
        ...
        <li><strong>Google Firebase</strong> — {t("Notificări push, analize — UE/SUA (cu SCC-uri)", "Push notifications, analytics — EU/US (with SCCs)")}</li>
      </ul>
